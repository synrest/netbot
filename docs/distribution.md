...
```sh
curl -fsSL https://github.com/synrest/netbot/releases/download/v0.4.5/bootstrap.sh \
  | sh -s -- 0.4.5 \
      https://github.com/synrest/netbot/releases/download/v0.4.5/netbot-0.4.5.zip \
