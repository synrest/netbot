...
```sh
curl -fsSL https://github.com/synrest/netbot/releases/download/v0.4.6/bootstrap.sh \
  | sh -s -- 0.4.6 \
      https://github.com/synrest/netbot/releases/download/v0.4.6/netbot-0.4.6.zip \
